...
class pygmaps:
	...
	def drawmap(self, f):
		...
		# f.write('\t\tvar styles = [{\n')
		# f.write('\t\t\tfeatureType: "all",\n')
		# f.write('\t\t\telementType: "labels",\n')
		# f.write('\t\t\tstylers: [\n')
		# f.write('\t\t\t\t{visibility: "off"\n')
		# f.write('\t\t\t]\n')
		# f.write('\t\t}];')
		#
		# f.write('var styledMap = new google.maps.StyledMapType(styles,{name: "Styled Map"});\n')
		...
		# f.write('\t\tmap.mapTypes.set("map_style", styledMap);\n')
  		# f.write('\t\tmap.setMapTypeId("map_style");\n')
		f.write('\n')
...
if __name__ == "__main__":
	...
	#========================================================================================
	points = [[5.40188366, 52.1706371], [6.07054565, 52.43992125], [5.99653287, 52.24437445], [5.9571941, 52.2014449], [5.77638889, 52.875], [5.941599, 52.2126306]] #, [12.44138889, 43.93833333]]
	center = [5.99083333, 52.21583333]
	clat = 0
	clong = 0
	for p in points:
		clat += p[0]
	...
	clat /= len(points)
	clong /= len(points)
	mymap = pygmaps(clong, clat, 12)#(50.621152 + 53.562744)/2, (3.240967 + 7.152100)/2, 8)
	...
	for p in points:
		mymap.addpoint(p[1], p[0], "#0000FF")
	mymap.addpoint(p[1], p[0], color="#00FF00")


	# mymap.addpoint(52.156137, 5.380554, "#0000FF")
	# mymap.addpoint(52.16, 5.39, "#0000FF")
